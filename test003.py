import sys
from PyQt6.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QLineEdit, QPushButton, QProgressBar, QDialog, QComboBox, QMessageBox
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        pixmap = pixmap.scaledToHeight(128, Qt.AspectRatioMode.KeepAspectRatio)
